...
<head>
    ...
    <title>Ganti Password â€” SIJAMAAH</title>
...
<body class="bg-gradient-to-b from-slate-100 via-slate-50 to-emerald-50 text-slate-800 min-h-screen pb-8">
    ...
    <div class="max-w-lg mx-auto px-4 mt-5">
        ...
        <div class="mb-4 flex items-center gap-2.5">
            <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-400 to-slate-600 flex items-center justify-center shadow-md">
            ...
            <div>
                <h1 class="text-[15px] font-bold text-slate-800 leading-tight">Ganti Password</h1>
                <p class="text-[11px] text-slate-400">Ubah password akun Anda</p>
            </div>
        </div>

        <!-- Success -->
        @if(session('success'))
            <div class="mb-4 p-3 bg-emerald-50 border border-emerald-200 text-emerald-700 rounded-lg flex items-center gap-2 text-sm alert-animate animate-fade-in">
        ...
        <!-- Form Card -->
        <form method="POST" action="{{ route('password.update') }}" class="bg-white rounded-xl shadow-lg p-6 animate-slide-up" style="animation-delay:0.1s">
            @csrf
