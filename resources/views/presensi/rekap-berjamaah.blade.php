...
<body class="bg-gradient-to-b from-slate-100 via-white to-emerald-50 text-slate-800 min-h-screen pb-8">
    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 mt-5">
        ...
        <div class="mb-4 flex items-center gap-2.5">
            ...
            <div>
                <h1 class="text-[15px] font-bold text-slate-800 leading-tight">Rekap Berjamaah</h1>
                <p class="text-[11px] text-slate-400">Rekap sholat berjamaah santri per periode</p>
            </div>
        </div>
